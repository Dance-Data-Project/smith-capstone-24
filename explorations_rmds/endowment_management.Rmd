...
**Endowment Management:** How are assets allocated across different asset classes in the endowment (stocks, bonds, real estate etc.)? Adjustment of endowment in response to the pandemic: How have the choices made within their asset allocation impacted their endowment performance? Ex: what percentage of the total endowment S&P 500?
...
```{r ma visualization, include=FALSE}
ma_asset_amt <- 
...
```{r ca visualization, include=FALSE}
ca_asset_amt <- 
