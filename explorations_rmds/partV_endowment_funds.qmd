...
-   In 2021, four out of the five largest endowments saw significant increases in their endowment balances, with end-of-year (EOY) balances surpassing beginning-of-year (BOY) balances.

-   These include: New York City Ballet, Houston Ballet, Alvin Ailey American Dance Theater, and Boston Ballet.

-   A similar pattern was observed in 2017, where three of these companies also encountered notable increases in their balances.

-   These include: New York City Ballet, Houston Ballet, and Alvin Ailey American Dance Theater.

-   As of the latest fiscal year, 2023, Boston Ballet stands alone with a positive balance difference, raising questions about potential differences in their endowment management and revenue vs expenses.
...
-   Fort Wayne Ballet and Grand Rapids Ballet experienced the most prominent activity in the endowment balance differences across the FY16-22. 

    -   In particular, of the six years,  they both experienced only two years of increasing differences and the other four years are characterized by declining differences. Indicating a long-term trend of a larger start of year balance than end of year balance.

-   Like the patterns observed with the Largest 5 in 2017,  three of the smallest 5  companies also encountered notable increases in their balances.

    -   These include: Ballet Quad Cities, Eugene Ballet and New Mexico Ballet Company.
