...
check_variable <- function(variable_name,
 ...
 data <- data %>%
  ...
  crossref <- data %>%
    ...
    mutate(
      difference_in_reported_year1 =  as.numeric(as.character(!!sym(vars[1]))) - 
        as.numeric(as.character(lag(!!sym(var), n =1))),
      difference_in_reported_year2 =  as.numeric(as.character(!!sym(vars[2]))) - 
        as.numeric(as.character(lag(!!sym(var), n =2))),
      difference_in_reported_year3 =  as.numeric(as.character(!!sym(vars[3]))) - 
        as.numeric(as.character(lag(!!sym(var), n =3))),
      difference_in_reported_year4 =  as.numeric(as.character(!!sym(vars[4]))) - 
        as.numeric(as.character(lag(!!sym(var), n =4)))
      )  %>%
    ungroup()
