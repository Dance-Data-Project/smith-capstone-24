---
title: "Rose's Work for Final Report"
author: "Rose Evard"
date: "`r Sys.Date()`"
output: pdf_document
---
...
low_forty %>%
  ...
  kbl(caption = "Endowment Percent Change Dropping Below 40 Percent Of Beginning Year balance",
...
high_200 %>%
  arrange(organization_name) %>%
  kbl(caption = "Endowment Percent Change Increasing Beyond 200 Percent Of Beginning Year Balance",
            col.names = c("Company Name", "Percent Change", "Beginning Balance", "End Balance", "Fiscal Year"),
            format="latex",
           booktabs=TRUE,
           escape=FALSE,
...
```{r, eval = TRUE}
endo_size_consist_fr
ggsave("consist_by_endo_size.png", path = here("final_report", "images"),width=4, height=6)
```

```{r, eval = TRUE}
employ_size_consist_ft
ggsave("consist_by_employ_count.png", path = here("final_report", "images"), width=4,height=6)
```
